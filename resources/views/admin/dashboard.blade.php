                                                ...
                                                <table class="table table-hover  table-borderless">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>16,300</td>
                                                            <td><canvas id="app-sale1" height="50" width="100"></canvas>
                                                            </td>
                                                            <td>$53</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>26,421</td>
                                                            <td><canvas id="app-sale2" height="50" width="100"></canvas>
                                                            </td>
                                                            <td>$35</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>8,265</td>
                                                            <td><canvas id="app-sale3" height="50" width="100"></canvas>
                                                            </td>
                                                            <td>$98</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>10,652</td>
                                                            <td><canvas id="app-sale4" height="50" width="100"></canvas>
                                                            </td>
                                                            <td>$20</td>
                                        ...
                                        <div class="card-block">
                                            <div class="row m-b-25">
                                                <div class="col-auto p-r-0">
                                                    <div class="u-img">
                                                        <img src="{{url('public/')}}//files/assets/images/breadcrumb-bg.jpg"
                                                            alt="user image" class="img-radius cover-img">
                                                        <img src="{{url('public/')}}//files/assets/images/avatar-2.jpg" alt="user image"
                                                                    ...
                                                                    <tr>
                                                                        <td class="b-none">
                                                                            <a href="#!" class="align-middle">
                                                                                <img src="{{url('public/')}}//files/assets/images/avatar-2.jpg"
                                                                                    alt="user image"
                                        ...
                                        <div class="row m-l-0 m-r-0">
                                            <div class="col-sm-4 bg-c-lite-green user-profile">
                                                <div class="card-block text-center text-white">
                                                    <div class="m-b-25">
                                                        <img src="{{url('public/')}}//files/assets/images/avatar-4.jpg"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <h6 class="text-muted f-w-400"><a
                                                                    ...
                                                                    class="__cf_email__"
                                                                    data-cfemail="6b010e05122b0c060a020745080406">[email&#160;protected]</a>
                                                            </h6>
                                                        </div>
                                                        <div class="col-sm-6">
