...
<div class="pcoded-content" id="printable">
    ...
    <div class="pcoded-inner-content">
		...
		<?php //print_r($app->user_data);die;?>
            <?php $jobDetail=json_decode(Auth::user()->user_data);?>
                        ...
                        <div class="col-lg-12 col-xs-12">
                            ...
                            <div class="form-group border rounded p-1">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-xs-3">
                                        <label>5. Graduation Certificate</label>
                                    </div>
                                    <div class="col-lg-3 col-xs-3">
                                        <span id="graduation_image">
										@if(isset($jobDetail->graduation_cer_url))
                                        <a target="_blank" href="{{url('').'/public'.$jobDetail->graduation_cer_url[0]}}"> view</a>
										@endif
										</span>
                                    </div>
                                    <div class="col-lg-3 col-xs-3">
                                        <label>6. Experience Certificates</label>
                                    </div>
                                    <div class="col-lg-3 col-xs-3">
                                        <span id="experience_certi_image">
										@if(isset($jobDetail->experience_certi_url))
                                        <a target="_blank" href="{{url('').'/public'.$jobDetail->experience_certi_url[0]}}"> view</a>
										@endif
										</span>
                                    </div>
                                </div>
