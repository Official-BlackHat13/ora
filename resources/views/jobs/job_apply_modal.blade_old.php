<div class="modal fade" id="AddBoxes" tabindex="-1" role="dialog" aria-labelledby="AddBoxesLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-xl" style="max-width: 95%!important" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('job-apply') }}" id="jobApplyForm" method="post"
                ...
                <div class="modal-body ">
                    ...
                    <div class="ml-1">➊ Each column should be filled. Digital India Corporation may not
                        consider this application, unless all columns have been filled.</div>
                    <div class="ml-1">➋ All fields with <span class="text-danger"><strong>*</strong></span> are
                        Mandarory</div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="first_name">1. Name of Applicantdnsvn <span
                                        class="text-danger"><strong>*</strong></span> <span style="font-size: 11px;">(As
                                        per 10th certificate)</span></label>
                                <div class="row">
                                    <div class="col-lg-4">
                        ...
                        <div class="col-lg-12">
                            <label for="previous_interview_detail">13. Academic & Professional qualifications <span
                                    ...
                                    style="font-size: 11px;"><b>(beginning with the latest qualification and up to
                                        SSC, Document should not more than 500 KB. If your university is not mention in
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group border rounded p-1">
                                <ol>
                                    ...
                                    <li>
                                        <label>Your Singnature (Upload png/jpeg/jpg)</label>
                                        <label for="sign_card"
                                            class="feather icon-upload border p-1 bg-warning rounded"></label>
                                    ...
                                    <li>
                                        <label>ID Proof (upload pdf)</label>
                                        <label for="aadhar_card"
                                            class="feather icon-upload border p-1 bg-warning rounded"></label>
                                        <input style="display: none;" id="aadhar_card" name="aadhar_card[]" type="file"
                                            required />
                                    ...
                                    <li>
                                        <label>Upload 10th Cerificate(upload pdf)</label>
                                        <label for="tenth_cer"
                                            class="feather icon-upload border p-1 bg-warning rounded"></label>
                                        <input style="display: none;" id="tenth_cer" name="tenth_cer[]" type="file"
                                            required />
                                        <span id="tenth_image"></span>
                                    </li>
                                    <li>
                                        <label>Upload 10+2 Certificate(upload pdf)</label>
                                        <label for="twelve_cer"
                                            class="feather icon-upload border p-1 bg-warning rounded"></label>
                                        <input style="display: none;" id="twelve_cer" name="twelve_cer[]" type="file"
                                            required />
...
<script type="text/javascript">
    //$(document).on('bind',"#acadmic_file_1",function () {
