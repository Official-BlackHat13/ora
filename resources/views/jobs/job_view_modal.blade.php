        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="dom-jqry" class="container-fluid">
                    <div class="row">
                        <div class="mt-1 col-6 col-md-3 font-weight-bold"> Job Title</div>
                        <div class="mt-1 col-6 col-md-3" id="t_job_title"></div>
                        <div class="mt-1 col-6 col-md-3 font-weight-bold">Job Category</div>
                        <div class="mt-1 col-6 col-md-3" id="t_job_category"></div>
                    </div>
                    <div class="row" id="may_be_hide">
                        <div class="mt-1 col-6 col-md-3 font-weight-bold">Band</div>
                        <div class="mt-1 col-6 col-md-3" id="t_band"></div>
                        <div class="mt-1 col-6 col-md-3 font-weight-bold">Report To</div>
                        <div class="mt-1 col-6 col-md-3" id="t_report_to"></div>
                    </div>
                    <div class="row">
